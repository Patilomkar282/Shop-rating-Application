...
A full-stack role-based **Store Rating Web Application** developed as part of the **FullStack Intern Coding Challenge**.  
The platform allows users to register, log in, browse stores, and submit ratings, while administrators and store owners have access to dedicated dashboards and management functionalities.
